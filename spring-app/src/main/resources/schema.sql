...
ALTER TABLE position_permissions DROP COLUMN IF EXISTS can_cafe_customer;
...
MERGE INTO position_permissions KEY(position) VALUES ('顧客', 'VIEWER', FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, CURRENT_TIMESTAMP());

ALTER TABLE position_permissions ADD COLUMN IF NOT EXISTS can_cafe_customer BOOLEAN NOT NULL DEFAULT FALSE;
